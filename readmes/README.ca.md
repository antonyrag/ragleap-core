...
**Agents d'IA autònoms — no només RAG.**
...
RagLeap Core és el motor de codi obert darrere de RagLeap — un sistema agèntic autoallotjat que gestiona el vostre negoci des dels vostres propis documents al vostre propi servidor, sense cap dependència del proveïdor.

**46 empleats d'IA basats en rols:** 9 rols generalistes principals (Gestor d'IA, Secretari, CEO, Vendes, Suport, RRHH, Finances, Màrqueting, Operacions) més 37 rols globals específics del sector.

**Què fa:**
- Memòria d'autoaprenentatge ponderada per resultats
- Activadors de flux de treball automàtics i escalada
- Modes d'autonomia plena / semiplena
- Bucle pensa-actua-decideix, no només recuperació

[Quickstart](#inici-ràpid) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Si us és útil, considereu posar una estrella al repositori — ajuda realment a que més gent el trobi.
...
**La manera més ràpida de provar-ho** — una ordre comprova Docker, clona el repositori i configura `.env` per a vosaltres:
