...
**Автономни AI агенти — не само RAG.**
...
RagLeap Core е двигателят с отворен код зад RagLeap — самостоятелно хоствана, агентна система, която управлява вашия бизнес от вашите собствени документи на вашия собствен сървър, без зависимост от доставчик.

**46 ролеви AI служители:** 9 основни генералистични роли (AI Мениджър, Секретар, Изпълнителен директор, Продажби, Поддръжка, HR, Финанси, Маркетинг, Операции) плюс 37 вертикално-специфични глобални роли.

**Какво прави:**
- Самообучаваща се, претеглена по резултати памет
- Автоматично задействане на работни потоци и ескалация
- Режими на пълна / полупълна автономност
- Цикъл мисли-действай-решавай, не само извличане

[Quickstart](#бърз-старт) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Ако това ви помага, моля помислете за поставяне на звезда на репото — това наистина помага на повече хора да го намерят.
...
**Най-бързият начин да го изпробвате** — една команда проверява Docker, клонира хранилището и настройва `.env` за вас:
