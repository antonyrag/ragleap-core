...
**Autonoomsed AI Agendid — Mitte Ainult RAG.**
...
RagLeap Core on RagLeapi taga olev avatud lähtekoodiga mootor — ise majutatud, agentiline süsteem, mis haldab teie äri teie enda dokumentidest teie enda serveris, ilma tarnija lukustuseta.

**46 rollipõhist AI töötajat:** 9 peamist üldrolli (AI juht, sekretär, tegevjuht, müük, tugi, HR, rahandus, turundus, toimingud) pluss 37 vertikaalset globaalset rolli.

**Mida see teeb:**
- Eneseopiv, tulemuspõhiselt kaalutud mälu
- Automaatsed töövoo päästikud ja eskaleerumine
- Täis- / poolautonoomia režiimid
- Mõtle-tegutse-otsusta tsükkel, mitte ainult otsimine

[Quickstart](#kiire-alustamine) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Kui see aitab, kaaluge repo tähistamist — see aitab tõesti rohkematel inimestel seda leida.
...
**Kiireim viis seda proovida** — üks käsk kontrollib Dockerit, klooni repo ja seadistab `.env` teie jaoks:
