...
**Agenti AI Autonomi — Non Solo RAG.**
...
RagLeap Core è il motore open-source dietro RagLeap — un sistema agentivo auto-ospitato che gestisce la tua azienda dai tuoi documenti sul tuo server, senza alcun blocco del fornitore.

**46 dipendenti AI basati su ruoli:** 9 ruoli generalisti principali (Responsabile AI, Segretario, CEO, Vendite, Supporto, HR, Finanza, Marketing, Operazioni) più 37 ruoli globali specifici per settore.

**Cosa fa:**
- Memoria auto-apprendente, ponderata per i risultati
- Trigger automatici del flusso di lavoro ed escalation
- Modalità di autonomia piena / parziale
- Ciclo pensa-agisci-decidi, non solo recupero

[Quickstart](#avvio-rapido) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Se questo ti aiuta, considera di mettere una stella al repository.
...
**Il modo più veloce per provarlo** — un comando controlla Docker, clona il repository e imposta `.env` per te:
