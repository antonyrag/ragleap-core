...
**סוכני בינה מלאכותית אוטונומיים — לא רק RAG.**
...
RagLeap Core הוא המנוע בקוד פתוח מאחורי RagLeap — מערכת אגנטית עצמאית שמנהלת את העסק שלך מהמסמכים שלך בשרת שלך, ללא תלות בספק.

**46 עובדי בינה מלאכותית מבוססי תפקיד:** 9 תפקידים כלליים מרכזיים (מנהל בינה מלאכותית, מזכיר, מנכ"ל, מכירות, תמיכה, משאבי אנוש, פיננסים, שיווק, תפעול) ועוד 37 תפקידים עולמיים ספציפיים לתחום.

**מה זה עושה:**
- זיכרון מתלמד עצמאית, ממוקד תוצאות
- הפעלה אוטומטית של תהליכי עבודה והסלמה
- מצבי אוטונומיה מלאה / חלקית
- לולאת חשוב-פעל-החלט, לא רק אחזור

[Quickstart](#התחלה-מהירה) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ אם זה עוזר לך, שקול לתת כוכב למאגר — זה באמת עוזר לאנשים נוספים למצוא אותו.
...
**הדרך המהירה ביותר לנסות** — פקודה אחת בודקת Docker, משכפלת את המאגר ומגדירה `.env` עבורך:
