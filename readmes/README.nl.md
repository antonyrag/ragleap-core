...
**Autonome AI-agenten — niet alleen RAG.**
...
RagLeap Core is de open-source engine achter RagLeap — een zelf-gehost, agentisch systeem dat uw bedrijf runt vanuit uw eigen documenten op uw eigen server, zonder enige leveranciersafhankelijkheid.

**46 op rollen gebaseerde AI-medewerkers:** 9 kernrollen als generalist (AI-manager, secretaresse, CEO, verkoop, ondersteuning, HR, financiën, marketing, operaties) plus 37 verticaal-specifieke mondiale rollen.

**Wat het doet:**
- Zelflerend, resultaatgewogen geheugen
- Automatische workflow-triggers en escalatie
- Volledige / semi-autonomie modi
- Denk-handel-beslis-lus, niet alleen ophalen

[Quickstart](#snel-starten) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Als dit u helpt, overweeg dan de repo te markeren — dat helpt echt meer mensen om het te vinden.
...
**De snelste manier om het te proberen** — één opdracht controleert Docker, kloont de repo en stelt `.env` voor u in:
