...
**Autonome KI-Agenten — nicht nur RAG.**
...
RagLeap Core ist die Open-Source-Engine hinter RagLeap — ein selbstgehostetes, agentisches System, das Ihr Unternehmen von Ihren eigenen Dokumenten auf Ihrem eigenen Server aus verwaltet, ohne jegliche Anbieterabhängigkeit.

**46 rollenbasierte KI-Mitarbeiter:** 9 grundlegende Generalisten-Rollen (KI-Manager, Sekretär, CEO, Vertrieb, Support, HR, Finanzen, Marketing, Betrieb) plus 37 vertikal-spezifische globale Rollen.

**Was es tut:**
- Selbstlernendes, ergebnisgewichtetes Gedächtnis
- Automatische Workflow-Auslöser und Eskalation
- Vollständige / halbautonome Modi
- Denk-Handle-Entscheide-Schleife, nicht nur Abruf

[Quickstart](#schnellstart) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Wenn Ihnen das hilft, erwägen Sie bitte, das Repo zu markieren — das hilft wirklich mehr Menschen, es zu finden.
...
**Schnellste Möglichkeit zum Ausprobieren** — ein Befehl prüft Docker, klont das Repository und richtet `.env` für Sie ein:
