...
**Asiantau AI Ymreolaethol — Nid RAG yn Unig.**
...
Mae RagLeap Core yn beiriant cod agored y tu ôl i RagLeap — system asiantaidd hunan-westeiedig sy'n rhedeg eich busnes o'ch dogfennau eich hun ar eich gweinydd eich hun, heb unrhyw gloi at werthwr.

**46 o Weithwyr AI yn seiliedig ar rôl:** 9 rôl generalist craidd (Rheolwr AI, Ysgrifennydd, Prif Swyddog Gweithredol, Gwerthiant, Cymorth, AD, Cyllid, Marchnata, Gweithrediadau) a 37 o rolau byd-eang penodol i sector.

**Yr hyn y mae'n ei wneud:**
- Cof hunandysgu, wedi'i bwysoli â chanlyniadau
- Sbardunwyr llif gwaith awtomatig ac uwchgyfeirio
- Modiau ymreolaeth llawn / hanner
- Dolen meddwl-gweithredu-penderfynu, nid adfer yn unig

[Quickstart](#dechrau-cyflym) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Os yw hwn yn eich helpu, ystyriwch roi seren i'r repo — mae'n helpu mwy o bobl i'w ddarganfod.
...
**Y ffordd gyflymaf i'w brofi** — mae un gorchymyn yn gwirio Docker, yn clonio'r repo, ac yn gosod `.env` ar eich cyfer:
