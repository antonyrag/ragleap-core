...
**Autonomiczne Agenty AI — Nie tylko RAG.**
...
RagLeap Core to silnik open-source za RagLeap — samodzielnie hostowany, agentyczny system, który zarządza Twoim biznesem z Twoich własnych dokumentów na Twoim własnym serwerze, bez żadnego uzależnienia od dostawcy.

**46 opartych na rolach pracowników AI:** 9 głównych ról generalistycznych (Menedżer AI, Sekretarz, CEO, Sprzedaż, Wsparcie, HR, Finanse, Marketing, Operacje) plus 37 wertykalnie specyficznych ról globalnych.

**Co robi:**
- Samouczące się, ważone wynikami pamięć
- Automatyczne wyzwalacze przepływu pracy i eskalacja
- Tryby pełnej / częściowej autonomii
- Pętla myśl-działaj-decyduj, nie tylko pobieranie

[Quickstart](#szybki-start) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Jeśli to pomaga, rozważ oznaczenie repozytorium gwiazdką — naprawdę pomaga to więcej osobom je znaleźć.
...
**Najszybszy sposób na wypróbowanie** — jedno polecenie sprawdza Docker, klonuje repozytorium i konfiguruje `.env` dla Ciebie:
