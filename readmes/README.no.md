...
**Autonome AI-agenter — ikke bare RAG.**
...
RagLeap Core er open source-motoren bak RagLeap — et selvhostet, agentisk system som driver virksomheten din fra dine egne dokumenter på din egen server, uten noen leverandørinnlåsing.

**46 rollebaserte AI-ansatte:** 9 generalistroller (AI-leder, sekretær, CEO, salg, støtte, HR, økonomi, markedsføring, drift) pluss 37 vertikalt spesifikke globale roller.

**Hva det gjør:**
- Selvlærende, resultatvektet minne
- Automatiske arbeidsflytutløsere og eskalering
- Fullstendig / semi-autonomi moduser
- Tenk-handle-bestem-løkke, ikke bare henting

[Quickstart](#hurtigstart) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Hvis dette hjelper deg, vurder å stjerne repoet.
...
**Den raskeste måten å prøve det på** — én kommando sjekker Docker, kloner repoet og setter opp `.env` for deg:
