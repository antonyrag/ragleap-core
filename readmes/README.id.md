...
**Agen AI Otonom — Bukan Hanya RAG.**
...
RagLeap Core adalah mesin open-source di balik RagLeap — sistem agentik yang di-host sendiri yang menjalankan bisnis Anda dari dokumen Anda sendiri di server Anda sendiri, tanpa ketergantungan vendor apa pun.

**46 Karyawan AI berbasis peran:** 9 peran generalis inti (Manajer AI, Sekretaris, CEO, Penjualan, Dukungan, HR, Keuangan, Pemasaran, Operasi) ditambah 37 peran global spesifik vertikal.

**Yang dilakukannya:**
- Memori belajar mandiri, berbobot hasil
- Pemicu alur kerja otomatis dan eskalasi
- Mode otonomi penuh / semi
- Loop pikir-tindak-putuskan, bukan hanya pengambilan

[Quickstart](#mulai-cepat) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Jika ini membantu Anda, pertimbangkan untuk memberi bintang pada repo.
...
**Cara tercepat untuk mencobanya** — satu perintah memeriksa Docker, mengkloning repo, dan menyiapkan `.env` untuk Anda:
