...
**Autonóm AI ügynökök — nem csak RAG.**
...
A RagLeap Core a RagLeap mögött álló nyílt forráskódú motor — egy önhoszting, ügynöki rendszer, amely a saját dokumentumaiból kezeli vállalkozását a saját szerverén, bármilyen szállítói zárolás nélkül.

**46 szerepkör-alapú AI alkalmazott:** 9 alapvető generalista szerepkör (AI-menedzser, titkár, vezérigazgató, értékesítés, támogatás, HR, pénzügy, marketing, műveletek) és 37 vertikálisan specifikus globális szerepkör.

**Mit csinál:**
- Önmagától tanuló, eredményekkel súlyozott memória
- Automatikus munkafolyamat-kiváltók és eszkaláció
- Teljes / félautonómia módok
- Gondolkodj-cselekedj-dönts ciklus, nem csak keresés

[Quickstart](#gyors-indítás) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Ha ez segít, fontolja meg a repo csillagozását.
...
**A leggyorsabb mód a kipróbáláshoz** — egy parancs ellenőrzi a Dockert, klónozza a repót és beállítja a `.env`-t:
