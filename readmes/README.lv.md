...
**Autonomi MI aģenti — ne tikai RAG.**
...
RagLeap Core ir atvērtā koda dzinējs aiz RagLeap — pašmitināta, aģentiska sistēma, kas pārvalda jūsu biznesu no jūsu pašu dokumentiem jūsu pašu serverī, bez jebkādas piegādātāja saistīšanas.

**46 uz lomu balstīti MI darbinieki:** 9 galvenās generālista lomas (MI menedžeris, sekretārs, izpilddirektors, pārdošana, atbalsts, HR, finanses, mārketings, operācijas) plus 37 vertikāli specifiskas globālās lomas.

**Ko tas dara:**
- Pašmācoša, ar rezultātiem svērta atmiņa
- Automātiski darbplūsmas aktivizētāji un eskalācija
- Pilnīgas / daļējas autonomijas režīmi
- Domā-rīkojies-izlem cikls, nevis tikai meklēšana

[Quickstart](#ātrā-sākšana) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Ja tas jums palīdz, apsveriet repozitorijam zvaigznītes piešķiršanu.
...
**Ātrākais veids, kā to izmēģināt** — viena komanda pārbauda Docker, klonē repozitoriju un iestata `.env` jums:
