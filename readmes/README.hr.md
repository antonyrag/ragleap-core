...
**Autonomni AI agenti — ne samo RAG.**
...
RagLeap Core je open-source engine iza RagLeap-a — samostalno hostiran, agentski sustav koji vodi vaš posao iz vaših vlastitih dokumenata na vašem vlastitom poslužitelju, bez ikakvog zaključavanja dobavljača.

**46 AI zaposlenika temeljenih na ulozi:** 9 osnovnih generalističkih uloga (AI menadžer, tajnik, CEO, prodaja, podrška, HR, financije, marketing, operacije) plus 37 vertikalno-specifičnih globalnih uloga.

**Što radi:**
- Samopouzdano, rezultatima ponderirana memorija
- Automatski okidači tijeka rada i eskalacija
- Puni / polu-autonomni načini rada
- Petlja misli-djeluj-odluči, ne samo preuzimanje

[Quickstart](#brzi-početak) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Ako vam ovo pomaže, razmislite o označavanju repoa zvjezdicom.
...
**Najbrži način da ga isprobate** — jedna naredba provjerava Docker, klonira repo i postavlja `.env` za vas:
