...
**Автономные ИИ-агенты — не только RAG.**
...
RagLeap Core — это движок с открытым исходным кодом, лежащий в основе RagLeap — самостоятельно размещаемой, агентной системы, управляющей вашим бизнесом из ваших документов на вашем сервере без привязки к поставщику.

**46 ролевых ИИ-сотрудников:** 9 основных ролей универсалов (ИИ-менеджер, секретарь, генеральный директор, продажи, поддержка, HR, финансы, маркетинг, операции) и 37 вертикально-специфических глобальных ролей.

**Что он делает:**
- Самообучающаяся, взвешенная по результатам память
- Автоматические триггеры рабочих процессов и эскалация
- Режимы полной / частичной автономии
- Цикл думай-действуй-решай, а не только поиск

[Quickstart](#быстрый-старт) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Если это помогает, рассмотрите возможность поставить звезду репозиторию — это действительно помогает большему числу людей найти его.
...
**Самый быстрый способ попробовать** — одна команда проверяет Docker, клонирует репозиторий и настраивает `.env` за вас:
