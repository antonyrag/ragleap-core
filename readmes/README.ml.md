...
**സ്വയംഭരണ AI ഏജന്റുകൾ — RAG മാത്രമല്ല.**
...
RagLeap Core എന്നത് RagLeap-ന് പിന്നിലെ ഓപ്പൺ-സോഴ്‌സ് എഞ്ചിൻ ആണ് — ഒരു സ്വയം-ഹോസ്റ്റ് ചെയ്ത, ഏജന്റിക് സിസ്റ്റം, വെൻഡർ ലോക്ക്-ഇൻ ഇല്ലാതെ നിങ്ങളുടെ സ്വന്തം ഡോക്യുമെന്റുകളിൽ നിന്ന് നിങ്ങളുടെ ബിസിനസ് നടത്തുന്നു.

**46 റോൾ-ആധിഷ്ഠിത AI ജീവനക്കാർ:** 9 കോർ ജനറലിസ്റ്റ് റോളുകൾ (AI മാനേജർ, സെക്രട്ടറി, CEO, സെയിൽസ്, സപ്പോർട്ട്, HR, ഫിനാൻസ്, മാർക്കറ്റിംഗ്, ഓപ്പറേഷൻസ്) കൂടാതെ 37 വെർട്ടിക്കൽ-സ്പെസിഫിക് ഗ്ലോബൽ റോളുകൾ.

**ഇത് എന്ത് ചെയ്യുന്നു:**
- സ്വയം-പഠനം, ഫലം-ഭാരിത്ര മെമ്മറി
- ഓട്ടോ-ട്രിഗർ വർക്ക്ഫ്ലോകളും എസ്‌കലേഷനും
- പൂർണ്ണ / അർദ്ധ-സ്വഭരണ മോഡുകൾ
- ചിന്തിക്കൂ-പ്രവർത്തിക്കൂ-തീരുമാനിക്കൂ ലൂപ്പ്

[Quickstart](#ദ്രുത-ആരംഭം) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ ഇത് സഹായിക്കുകയാണെങ്കിൽ, repo-ന് ഒരു സ്റ്റാർ നൽകുന്നത് പരിഗണിക്കുക.
...
**ഇത് പ്രയോഗിക്കാനുള്ള ഏറ്റവും വേഗമേറിയ മാർഗ്ഗം** — ഒരു കമാൻഡ് Docker പരിശോധിക്കുന്നു, repo ക്ലോൺ ചെയ്യുന്നു, നിങ്ങൾക്കായി `.env` സജ്ജമാക്കുന്നു:
