...
**স্বায়ত্তশাসিত AI এজেন্ট — শুধু RAG নয়।**
...
RagLeap Core হল RagLeap-এর পেছনের ওপেন-সোর্স ইঞ্জিন — একটি স্বয়ং-হোস্টেড, এজেন্টিক সিস্টেম যা কোনো ভেন্ডর লক-ইন ছাড়াই আপনার নিজের সার্ভারে আপনার নিজের ডকুমেন্ট থেকে আপনার ব্যবসা পরিচালনা করে।

**৪৬ জন ভূমিকা-ভিত্তিক AI কর্মী:** ৯টি মূল সাধারণবাদী ভূমিকা (AI ম্যানেজার, সেক্রেটারি, সিইও, বিক্রয়, সহায়তা, HR, অর্থ, মার্কেটিং, অপারেশন) এবং ৩৭টি উল্লম্ব-নির্দিষ্ট বৈশ্বিক ভূমিকা।

**এটি যা করে:**
- স্ব-শিক্ষণ, ফলাফল-ভারযুক্ত মেমরি
- অটো-ট্রিগার ওয়ার্কফ্লো এবং এস্কেলেশন
- পূর্ণ / আধা স্বায়ত্তশাসন মোড
- চিন্তা-কাজ-সিদ্ধান্ত লুপ, শুধু পুনরুদ্ধার নয়

[Quickstart](#দ্রুত-শুরু) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ এটি যদি আপনাকে সাহায্য করে, অনুগ্রহ করে রেপোতে স্টার দেওয়ার কথা বিবেচনা করুন।
...
**এটি চেষ্টা করার দ্রুততম উপায়** — একটি কমান্ড Docker চেক করে, রেপো ক্লোন করে এবং আপনার জন্য `.env` সেট আপ করে:
