...
**Agents IA Autonomes — Pas Seulement RAG.**
...
RagLeap Core est le moteur open source derrière RagLeap — un système agentique auto-hébergé qui gère votre entreprise depuis vos propres documents sur votre propre serveur, sans aucun verrouillage fournisseur.

**46 employés IA basés sur des rôles :** 9 rôles généralistes principaux (Gestionnaire IA, Secrétaire, PDG, Ventes, Support, RH, Finance, Marketing, Opérations) plus 37 rôles mondiaux spécifiques au secteur.

**Ce qu'il fait :**
- Mémoire auto-apprenante, pondérée par les résultats
- Déclencheurs de workflow automatiques et escalade
- Modes d'autonomie totale / partielle
- Boucle penser-agir-décider, pas seulement de la récupération

[Quickstart](#démarrage-rapide) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Si cela vous aide, pensez à mettre une étoile au dépôt — cela aide vraiment plus de gens à le trouver.
...
**La façon la plus rapide de l'essayer** — une commande vérifie Docker, clone le dépôt et configure `.env` pour vous :
