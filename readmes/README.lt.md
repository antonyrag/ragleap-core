...
**Autonominiai DI agentai — ne tik RAG.**
...
RagLeap Core yra atvirojo kodo variklis už RagLeap — savarankiškai talpinamas, agentinis sistema, valdanti jūsų verslą iš jūsų pačių dokumentų jūsų pačių serveryje, be jokios priklausomybės nuo tiekėjo.

**46 vaidmenimis pagrįsti DI darbuotojai:** 9 pagrindiniai generalistiniai vaidmenys (DI vadybininkas, sekretorius, generalinis direktorius, pardavimai, palaikymas, HR, finansai, rinkodara, operacijos) ir 37 vertikaliai specifiniai globalūs vaidmenys.

**Ką jis daro:**
- Savarankiškai besimokanti, rezultatais sveriama atmintis
- Automatiniai darbo eigos paleidikliai ir eskalavimas
- Visiško / pusiau autonominio veikimo režimai
- Galvok-veik-nuspręsk ciklas, ne tik paieška

[Quickstart](#greita-pradžia) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Jei tai jums padeda, apsvarstyite repozitorijaus žvaigždutės suteikimą.
...
**Greičiausias būdas išbandyti** — viena komanda patikrina Docker, klonuoja saugyklą ir nustato `.env` jums:
