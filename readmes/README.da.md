...
**Autonome AI-agenter — ikke kun RAG.**
...
RagLeap Core er open source-motoren bag RagLeap — et selvhostet, agentisk system, der driver din virksomhed fra dine egne dokumenter på din egen server, uden nogen vendor lock-in.

**46 rollebaserede AI-medarbejdere:** 9 centrale generalistroller (AI-leder, sekretær, CEO, salg, support, HR, økonomi, marketing, drift) plus 37 vertikalt specifikke globale roller.

**Hvad det gør:**
- Selvlærende, resultatvægtet hukommelse
- Auto-udløste arbejdsgange og eskalering
- Fuld / semi-autonomi tilstande
- Tænk-handle-beslutte løkke, ikke kun hentning

[Quickstart](#hurtig-start) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Hvis dette hjælper dig, så overvej at stjerne repoet — det hjælper virkelig flere med at finde det.
...
**Den hurtigste måde at prøve det på** — én kommando tjekker Docker, kloner repoet og sætter `.env` op for dig:
