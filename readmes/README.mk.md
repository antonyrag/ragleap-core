...
**Автономни ВИ агенти — не само RAG.**
...
RagLeap Core е моторот со отворен код зад RagLeap — самостојно хостиран, агентски систем кој управува со вашиот бизнис од вашите сопствени документи на вашиот сопствен сервер, без какво и да е заклучување на продавачот.

**46 ВИ вработени засновани на улога:** 9 основни генералистички улоги (ВИ менаџер, секретар, извршен директор, продажба, поддршка, HR, финансии, маркетинг, операции) плус 37 вертикално специфични глобални улоги.

**Што прави:**
- Само-учечка, резултатно пондерирана меморија
- Автоматски активатори на работниот тек и ескалација
- Целосни / полу-автономни режими
- Размисли-дејствувај-одлучи циклус, не само пребарување

[Quickstart](#брз-почеток) · [Docs](https://docs.ragleap.com) · [Website](https://ragleap.com) · [Hosted Version](https://ragleap.com) · [Packages](https://packages.ragleap.com/)
...
> ⭐ Ако ова ви помага, размислете за ставање ѕвезда на репото.
...
**Најбрзиот начин да го испробате** — една команда проверува Docker, го клонира репото и го поставува `.env` за вас:
